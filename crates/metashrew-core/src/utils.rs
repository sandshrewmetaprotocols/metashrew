...
/// # Examples
/// ```rust,ignore
/// use metashrew_core::utils::consensus_encode;
...
/// # Examples
/// ```rust,ignore
/// use metashrew_core::utils::consensus_decode;
/// use bitcoin::Transaction;
/// use std::io::Cursor;
///
...
/// # Examples
/// ```rust,ignore
/// use metashrew_core::utils::consume_to_end;
/// use std::io::Cursor;
///
/// let data = vec![1, 2, 3, 4, 5];
/// let mut cursor = Cursor::new(data);
...
/// # Examples
/// ```rust,ignore
/// use metashrew_core::utils::consume_exact;
/// use std::io::Cursor;
///
/// let data = vec![1, 2, 3, 4, 5];
/// let mut cursor = Cursor::new(data);
...
/// # Examples
/// ```rust,ignore
/// use metashrew_core::utils::consume_varint;
/// use std::io::Cursor;
///
...
/// # Examples
/// ```rust,ignore
/// use metashrew_core::utils::format_key;
///
